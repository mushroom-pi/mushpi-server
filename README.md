...
Everything I consider relevant when creating a NestJS REST API.

## What's included

Make sure you have a basic understanding of these features before you start using this repo.

- [Swagger Documentation](/src/modules/swagger/swagger.readme.md)
- Validation pipe
- Pino logger
- [Error Handling](/src/filters/exceptions.readme.md)
- Gitflow
- Environment variables validation and docs generator.
